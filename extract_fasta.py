...
# Create the parser
parser = argparse.ArgumentParser(description="Filter sequences from a fasta file based on a list of input contig ids.")

# Add the arguments
parser.add_argument("--input_fasta", "-i", required=True, help="Input fasta file.")
parser.add_argument("--id_file", required=True, help="List of contig ids to extract from fasta file.")
